...
function nino34 = ENSO_index;
data=[ 1981    -0.45   -0.45   -0.02   -0.17   -0.11   -0.15   -0.43   -0.18   -0.07   -0.03   -0.27    0.07
 1982    -0.04   -0.13   -0.02    0.24    0.65    0.92    0.64    0.93    1.39    2.00    2.07    2.33
 ...
 2013    -0.42   -0.40   -0.14   -0.08   -0.28   -0.33   -0.28   -0.29   -0.09   -0.24   -0.02   -0.09
 2014    -0.42   -0.45   -0.07    0.28    0.45    0.48    0.13    0.14    0.37    0.48    0.89    0.77
 2015     0.59    0.57    0.48    0.90    1.04    1.28    1.56    1.87    2.01    2.21    2.57    2.56
 ...
 2023    -0.78   -0.62   -0.13    0.24    0.47    0.95    1.20    1.56    1.65    1.59    2.01    1.81
 2024     1.71    1.47    1.10    0.93    0.41  -99.99  -99.99  -99.99  -99.99  -99.99  -99.99  -99.99
];
...
for yr = year(1): year(end)
    ...
    for imon = 1:12
        c = c+1;
        k = k+1;
        nino34.time(k) = datenum(yr,imon, 15);
        nino34.index(k) = data(r,c);
    end
end

iend =find (nino34.time == datenum(2024,3,15));
istr =find (nino34.time == datenum(1981,9,15));
nino34.index = nino34.index(istr:iend);
nino34.time = nino34.time(istr:iend);
